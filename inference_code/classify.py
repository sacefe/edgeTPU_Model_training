...
def get_output(interpreter, top_k, score_threshold):
    ...
    # print("scores: ", scores, categories)
...
def main():
    ...
    # default_model = 'mobilenet_v2_1.0_224_quant_cmpe297.tflite'  #no edgeTPU
    # default_labels = 'imagenet_labels.txt' 

    default_model_dir = '../cmpe297_model'
    default_model = 'mobilenet_6classify_v2_1.0_224_quant_screw_edgetpu.tflite'
    default_labels = 'mobilenet_6classify_screw_labels.txt'

    # # default_model = 'Sergio_v2_mobilenet_v2_1.0_224_quant.tflite'
    # default_model = 'Sergio_v2_mobilenet_v2_1.0_224_quant_edgetpu.tflite'

    # default_model = 'eager2_mobilenet_v2_1.0_224_quant_edgetpu.tflite'
    # default_labels = 'flower_labels_cmpe297.txt'

    # # default_model = 'mobilenet_v2_1.0_224_quant_praveen.tflite'  #praveen
    # # default_labels = 'praveen.txt'

    # default_model_dir = '../cmpe297_model'

    # default_model = 'Sergio_mobilenet_v2_1.0_224_quant_edgetpu.tflite'
    # # default_model = 'Sergio_mobilenet_v2_1.0_224_quant.tflite'
    # default_labels = 'flower_labels_cmpe297.txt'
